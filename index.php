...
<html>
  <head>
    <title>Aplikasi Enkripsi dan Dekripsi SMP Negeri 189 Jakarta Barat</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <h1>SMP Negeri 189 Jakarta Barat</h1>
      </div>
      <div class="login-box">
        <form class="login-form" action="auth.php" method="post">
          ...
          <div class="form-group btn-container">
            ...
            <p style="font-size:10pt">Copyright 2022 - SMP Negeri 189 Jakarta</p>
          </div>
        </form>
      </div>
    </section>
