    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i> Statistik Aplikasi Enkripsi dan Dekripsi SMP Negeri 189 Jakarta Barat</h1>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <legend>Bantuan Dalam Penggunaan Aplikasi Enkripsi dan Dekripsi</legend>
                ...
                <li>Menu Daftar List merupakan menu untuk melihat dafar file yang telah dienkripsi dan didekripsi</li>
                <li>Menu Tentang merupakan maksud dari Aplikasi ini, dan juga terdapat Visi dan Misi dari SMP Negeri 189.</li>
